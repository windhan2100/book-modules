...
//	}
    ...
    /**
     * 
     * getDate:(获取一天的开始时间和结束时间用0:0:0:0 - 23:59:59:999) 
     * @param dayCount
     * @param millisecond
     * @return
     *
     * @date 2017年6月15日 上午10:50:10
     * @author liweihan
     */
    public static synchronized Date getDate(String dateTime,int dayCount,int millisecond) {
    	Date date = string2Date(dateTime);
    	
    	Calendar currentDate = Calendar.getInstance();
    	currentDate.setTime(date);
    	currentDate.add( Calendar.DATE, dayCount );
    	currentDate.set(Calendar.HOUR_OF_DAY, 0); //Calendar.HOUR_OF_DAY是24小时制 ,Calendar.HOUR是12小时制
    	currentDate.set(Calendar.MINUTE, 0);
    	currentDate.set(Calendar.SECOND, 0);
    	currentDate.set(Calendar.MILLISECOND,0);
    	currentDate.add(Calendar.MILLISECOND, millisecond);
    	return currentDate.getTime();
    }
